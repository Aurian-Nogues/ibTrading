...
# #if after 1 hour position is still open, close it
    ...
    schedule.every().day.at("14:00").do(futArbInitial)
    schedule.every().day.at("14:01").do(futArbMonitor)
    schedule.every().day.at("14:02").do(futArbMonitor)
    schedule.every().day.at("14:03").do(futArbMonitor)
    schedule.every().day.at("14:04").do(futArbMonitor)
    schedule.every().day.at("14:05").do(futArbMonitor)
    schedule.every().day.at("14:06").do(futArbMonitor)
    schedule.every().day.at("14:07").do(futArbMonitor)
    schedule.every().day.at("14:08").do(futArbMonitor)
    schedule.every().day.at("14:09").do(futArbMonitor)
    schedule.every().day.at("14:10").do(futArbMonitor)
    schedule.every().day.at("14:11").do(futArbMonitor)
    schedule.every().day.at("14:12").do(futArbMonitor)
    schedule.every().day.at("14:13").do(futArbMonitor)
    schedule.every().day.at("14:14").do(futArbMonitor)
    schedule.every().day.at("14:15").do(futArbMonitor)
    schedule.every().day.at("14:16").do(futArbMonitor)
    schedule.every().day.at("14:17").do(futArbMonitor)
    schedule.every().day.at("14:18").do(futArbMonitor)
    schedule.every().day.at("14:19").do(futArbMonitor)
    schedule.every().day.at("14:20").do(futArbMonitor)
    schedule.every().day.at("14:21").do(futArbMonitor)
    schedule.every().day.at("14:22").do(futArbMonitor)
    schedule.every().day.at("14:23").do(futArbMonitor)
    schedule.every().day.at("14:24").do(futArbMonitor)
    schedule.every().day.at("14:25").do(futArbMonitor)
    schedule.every().day.at("14:26").do(futArbMonitor)
    schedule.every().day.at("14:27").do(futArbMonitor)
    schedule.every().day.at("14:28").do(futArbMonitor)
    schedule.every().day.at("14:29").do(futArbMonitor)
    schedule.every().day.at("14:30").do(futArbMonitor)
    schedule.every().day.at("14:31").do(futArbMonitor)
    schedule.every().day.at("14:32").do(futArbMonitor)
    schedule.every().day.at("14:33").do(futArbMonitor)
    schedule.every().day.at("14:34").do(futArbMonitor)
    schedule.every().day.at("14:35").do(futArbMonitor)
    schedule.every().day.at("14:36").do(futArbMonitor)
    schedule.every().day.at("14:37").do(futArbMonitor)
    schedule.every().day.at("14:38").do(futArbMonitor)
    schedule.every().day.at("14:39").do(futArbMonitor)
    schedule.every().day.at("14:40").do(futArbMonitor)
    schedule.every().day.at("14:41").do(futArbMonitor)
    schedule.every().day.at("14:42").do(futArbMonitor)
    schedule.every().day.at("14:43").do(futArbMonitor)
    schedule.every().day.at("14:44").do(futArbMonitor)
    schedule.every().day.at("14:45").do(futArbMonitor)
    schedule.every().day.at("14:46").do(futArbMonitor)
    schedule.every().day.at("14:47").do(futArbMonitor)
    schedule.every().day.at("14:48").do(futArbMonitor)
    schedule.every().day.at("14:49").do(futArbMonitor)
    schedule.every().day.at("14:50").do(futArbMonitor)
    schedule.every().day.at("14:51").do(futArbMonitor)
    schedule.every().day.at("14:52").do(futArbMonitor)
    schedule.every().day.at("14:53").do(futArbMonitor)
    schedule.every().day.at("14:54").do(futArbMonitor)
    schedule.every().day.at("14:55").do(futArbMonitor)
    schedule.every().day.at("14:56").do(futArbMonitor)
    schedule.every().day.at("14:57").do(futArbMonitor)
    schedule.every().day.at("14:58").do(futArbMonitor)
    schedule.every().day.at("14:59").do(futArbMonitor)


    schedule.every().day.at("15:00").do(futArbTimingClose)
